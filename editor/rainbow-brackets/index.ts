// Based on https://github.com/eriknewland/rainbowbrackets
...
export const rainbowBracketsPlugin = ViewPlugin.fromClass(
  class {
    decorations
...
export const rainbowBracketsTheme = EditorView.baseTheme({
